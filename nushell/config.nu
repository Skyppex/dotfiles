...
$env.config = {
    ...
    keybindings: [
        ...
        {
            name: move_one_word_right_or_take_history_hint1
            modifier: control
            keycode: right
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_to_line_end_or_take_history_hint1
            modifier: none
            keycode: end
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_to_line_end_or_take_history_hint2
            modifier: control
            keycode: char_e
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: delete_one_word_backward1
            modifier: control
            keycode: backspace
            mode: [emacs, vi_insert]
        ...
        {
            name: delete_one_character_forward1
            modifier: none
            keycode: delete
            mode: [emacs, vi_insert]
            event: {edit: delete}
        ...
        {
            name: delete_one_character_forward2
            modifier: control
            keycode: delete
            mode: [emacs, vi_insert]
            event: {edit: delete}
        ...
        {
            name: delete_one_character_forward3
            modifier: control
            keycode: char_h
            mode: [emacs, vi_insert]
            event: {edit: backspace}
        ...
        {
            name: delete_one_word_backward2
            modifier: control
            keycode: char_w
            mode: [emacs, vi_insert]
            event: {edit: backspaceword}
        ...
        {
            name: move_one_word_right_or_take_history_hint2
            modifier: alt
            keycode: right
            mode: emacs
            event: {
        ...
        {
            name: move_one_word_right_or_take_history_hint3
            modifier: alt
            keycode: char_f
            mode: emacs
            event: {
        ...
        {
            name: delete_one_word_backward3
            modifier: alt
            keycode: backspace
            mode: emacs
            event: {edit: backspaceword}
        ...
        {
            name: delete_one_word_backward4
            modifier: alt
            keycode: char_m
            mode: emacs
            event: {edit: backspaceword}
