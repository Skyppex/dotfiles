...
Group.new("EndOfBuffer", c.secondary)
...
Group.new("TabLineSel", c.primary)
...
-- treesitter but addressable
Group.new("Boolean", c.red)
Group.new("Character", c.red)
Group.new("CharacterSpecial", c.red)
Group.new("Comment", c.quaternary)
Group.new("Conditional", c.purple)
Group.new("Constant", c.red)
Group.new("ConstantBuiltin", c.red)
Group.new("ConstantMacro", c.cyan)
Group.new("Constructor", c.yellow)
Group.new("Debug", c.pink)
Group.new("Define", c.purple)
Group.new("Exception", c.purple)
...
Group.new("Float", c.orange)
Group.new("Function", c.yellow)
Group.new("FunctionBuiltin", c.yellow)
Group.new("FunctionCall", c.yellow)
Group.new("FunctionMacro", c.yellow)
Group.new("Include", c.purple)
Group.new("Keyword", c.purple)
Group.new("KeywordFunction", c.purple)
Group.new("KeywordOperator", c.red)
Group.new("KeywordReturn", c.purple)
Group.new("Label", c.cyan)
Group.new("Macro", c.pink)
Group.new("Method", c.yellow)
Group.new("MethodCall", c.yellow)
Group.new("Namespace", c.blue)
Group.new("None", c.red)
Group.new("Module", c.pink)
Group.new("Number", c.orange)
...
Group.new("Property", c.pink)
Group.new("Punctuation", c.primary)
Group.new("PunctuationBracket", c.yellow)
Group.new("PunctuationDelimiter", c.primary)
Group.new("PunctuationSpecial", c.red)
Group.new("Repeat", c.purple)
Group.new("Storageclass", c.purple)
Group.new("String", c.green)
Group.new("StringEscape", c.green)
Group.new("StringSpecial", c.red)
Group.new("StringRegexp", c.blue)
Group.new("Structure", c.cyan)
Group.new("Tag", c.pink)
Group.new("TagAttribute", c.pink)
Group.new("TagDelimiter", c.pink)
Group.new("TextLiteral", c.green)
Group.new("TextReference", c.red)
Group.new("TextTitle", c.pink)
Group.new("TextTodo", c.pink)
Group.new("TextUnderline", c.green)
Group.new("TextUri", c.purple)
Group.new("Type", c.yellow)
Group.new("Identifier", c.yellow)
Group.new("TypeBuiltin", c.purple)
Group.new("TypeDefinition", c.yellow)
Group.new("Variable", c.cyan)
...
-- Json
Group.new("jsonKeyword", g.Keyword, g.Keyword)
Group.new("jsonKeywordMatch", g.Keyword, g.Keyword)
Group.new("jsonQuote", g.String, g.String)
Group.new("jsonString", g.String, g.String)
Group.new("jsonStringMatch", g.String, g.String)
Group.new("jsonEscape", g.StringEscape, g.StringEscape)
Group.new("jsonNumber", g.Float, g.Float)
Group.new("jsonPadding", c.pink)
Group.new("jsonBoolean", g.Boolean, g.Boolean)
Group.new("jsonNull", g.Keyword, g.Keyword)
Group.new("jsonBraces", c.cyan)
Group.new("jsonFold", g.Folded, g.Folded)
Group.new("jsonTest", c.background2)

Group.new("jsonStringSQError", c.error)
Group.new("jsonNoQuotesError", c.error)
Group.new("jsonTripleQuotesError", c.error)
Group.new("jsonNumError", c.error)
Group.new("jsonCommentError", c.error)
Group.new("jsonSemicolonError", c.error)
...
Group.new("MiniIconsCyan", c.cyan)
Group.new("MiniIconsGreen", c.green)
Group.new("MiniIconsGrey", c.tertiary)
Group.new("MiniIconsOrange", c.orange)
Group.new("MiniIconsPurple", c.purple)
Group.new("MiniIconsRed", c.red)
Group.new("MiniIconsYellow", c.yellow)

Group.new("MiniPickBorder", g.FloatBorder, g.FloatBorder)
Group.new("MiniPickBorderBusy", g.DiagnosticWarn, g.DiagnosticWarn)
Group.new("MiniPickBorderText", c.cyan)
Group.new("MiniPickIconDirectory", g.Directory, g.Directory)
Group.new("MiniPickNormal", g.NormalFloat, g.NormalFloat)
Group.new("MiniPickIconFile", g.MiniPickNormal, g.MiniPickNormal)
Group.new("MiniPickHeader", g.DiagnosticHint, g.DiagnosticHint)
Group.new("MiniPickMatchCurrent", g.Visual, g.Visual)
Group.new("MiniPickMatchMarked", c.info)
Group.new("MiniPickMatchRanges", g.DiagnosticHint, g.DiagnosticHint)
Group.new("MiniPickPreviewLine", g.CursorLine, g.CursorLine)
Group.new("MiniPickPreviewRegion", g.IncSearch, g.IncSearch)
Group.new("MiniPickPrompt", g.DiagnosticInfo, g.DiagnosticInfo)
Group.new("MiniPickPromptCaret", g.MiniPickPrompt, g.MiniPickPrompt)
...
Group.new("BlinkCmpKindFunction", g.Function)
Group.new("BlinkCmpKindConstructor", g.Constructor)
Group.new("BlinkCmpKindField", g.Field)
Group.new("BlinkCmpKindVariable", g.Variable)
Group.new("BlinkCmpKindClass", g.Type)
Group.new("BlinkCmpKindInterface", g.Type)
Group.new("BlinkCmpKindModule", g.Module)
Group.new("BlinkCmpKindProperty", g.Property)
Group.new("BlinkCmpKindUnit", g.Type)
Group.new("BlinkCmpKindValue", g.Constant)
Group.new("BlinkCmpKindEnum", g.Type)
Group.new("BlinkCmpKindKeyword", g.Keyword)
Group.new("BlinkCmpKindSnippet", c.cyan)
Group.new("BlinkCmpKindColor", c.orange)
Group.new("BlinkCmpKindFile", g.Directory)
Group.new("BlinkCmpKindReference", g.TextReference)
Group.new("BlinkCmpKindFolder", g.Directory)
Group.new("BlinkCmpKindEnumMember", g.Type)
Group.new("BlinkCmpKindConstant", g.Constant)
Group.new("BlinkCmpKindStruct", g.Type)
Group.new("BlinkCmpKindEvent", g.Constant)
Group.new("BlinkCmpKindOperator", g.Operator)
Group.new("BlinkCmpKindTypeParameter", g.Parameter)
Group.new("BlinkCmpKindVersion", g.Type)
Group.new("BlinkCmpKindFeature", g.Module)
