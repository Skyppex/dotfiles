...
hl.config({
	general = {
		...
		col = {
			active_border = style.active,
			inactive_border = style.inactive,
	...
	group = {
		col = {
			border_active = style.active,
			border_inactive = style.inactive,
			border_locked_active = style.active,
			border_locked_inactive = style.inactive,
		},
		groupbar = {
			enabled = false,
		},
