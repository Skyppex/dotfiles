...
hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("nu ~/.config/hypr/scripts/player-play-pause"), { locked = true })
hl.bind("XF86AudioPause", hl.dsp.exec_cmd("nu ~/.config/hypr/scripts/player-play-pause"), { locked = true })
